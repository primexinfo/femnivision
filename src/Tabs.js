  ...
  <div class="accordion-item">
    ...
    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      <div class="accordion-body ">
        ...
        <span className="tabtext">What do you see when you look in the mirror?
...
at one point or another, and they all relate to body image.</span>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
      ...
      <span className="tabtext"> •Gastroesophageal reflux disease (GERD) <br />
•Diabetes risk, metabolic syndrome, and prediabetes <br />
•Type 2 diabetes <br />
•Asthma/reactive airway disease <br />
•Cardiovascular disease* and cardiovascular disease mortality <br />
 Hypertension <br />
•Polycystic ovary syndrome (PCOS) <br />
•Urinary stress incontinence</span>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
      ...
      <span className="tabtext"> Common eating disorders include  anorexia nervosa,
...
people worry about their <br /> weight, what they eat, and how they look. </span>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      ...
      <span className="tabtext"> The state of being connected by blood, marriage or adoption. Maintaining
...
healthy relationships.</span>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
      ...
      <span className="tabtext">Positive relationships in the workplace are an integral part of career success.
...
intelligence and <br /> getting to know your coworkers.</span>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
      ...
      <span className="tabtext"> Love is one of the most profound emotions known to human beings. There
...
and social contact.</span>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      ...
      <span className="tabtext">The first thing to note is the fact that ‘fear’ and ‘phobia’ are not the
...
will cause irrational fear that will consume most of most of your time and energy.</span>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
      ...
      <span className="tabtext">Panic attacks are classified into three basic types: Spontaneous or uncued
...
20s, but they can also happen to children.</span>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
      ...
      <span className="tabtext"> Stress is a biological reaction that all of us can experience at any age.
...
Health, as we get older, stress can come “as a result of managing br
 chronic illness, losing a spouse, being a caregiver, or adjusting to changes due to
...
stress can be difficult to manage and it could be harmful to your health.</span>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
      ...
      <span className="tabtext"> Motivation is our drive to do things. It’s the element that keeps us moving 
towards our goals. Motivation is essential and can go up and down depending
on our self-control and other external circumstances that affect our action. 
These uncontrollable factors further define the level of motivation a person has
in terms of achievement.  You do the action and then the motivation comes not
